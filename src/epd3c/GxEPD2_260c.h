...
#ifndef _GxEPD2_260c_H_
#define _GxEPD2_260c_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_260c : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 152;
    static const uint16_t HEIGHT = 296;
    static const GxEPD2::Panel panel = GxEPD2::GDEW026Z39;
    ...
    // constructor
    GxEPD2_260c(int8_t cs, int8_t dc, int8_t rst, int8_t busy);
    // methods (virtual)
